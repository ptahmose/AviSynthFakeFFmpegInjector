namespace FFmpegAviSynthLib
{
    ...
    public class FFmpegRunner
    {
        ...
        public void Start()
        {
            ...
            startInfo.Arguments =
                @" -v info -i D:\Dev\GitHub\AviSynthFakeFFmpegInjector\AviSynthFFmpegInjector\Build\VS\x64\Debug\SCRIPT.avs -aspect 16:9 -c:v h264_nvenc -rc constqp -preset hq OUT.mp4";
